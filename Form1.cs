            ...
            for (int j = 0; j < row_range_total; j++)
            {
                ...
                {                                       // asdf.runfx(1);  {cb_아몰랑}  public void asdf(속성 변수, 속성 변수) 해서 변수에 cb_1 , dan_1 이런식으로 넣어도 될듯
                    if (cb_1.Text.Equals("1"))
                    {
                        ...
                        Thread.Sleep(int.Parse(sec1.Text));
                    }
                    else if (cb_1.Text == "인")
                    {
                        index_fx(j);
                ...
                {                                       // asdf.runfx(1);  {cb_아몰랑}  public void asdf(속성 변수, 속성 변수) 해서 변수에 cb_1 , dan_1 이런식으로 넣어도 될듯
                    if (cb_2.Text.Equals("2"))
                    {
                        ...
                        Thread.Sleep(int.Parse(sec2.Text));
                    }
                    else if (cb_2.Text == "인")
                    {
                        index_fx(j);
                ...
                {                                       // asdf.runfx(1);  {cb_아몰랑}  public void asdf(속성 변수, 속성 변수) 해서 변수에 cb_1 , dan_1 이런식으로 넣어도 될듯
                    if (cb_3.Text.Equals("3"))
                    {
                        ...
                        Thread.Sleep(int.Parse(sec3.Text));
                    }
                    else if (cb_3.Text == "인")
                    {
                        index_fx(j);
                ...
                {                                       // asdf.runfx(1);  {cb_아몰랑}  public void asdf(속성 변수, 속성 변수) 해서 변수에 cb_1 , dan_1 이런식으로 넣어도 될듯
                    if (cb_4.Text.Equals("4"))
                    {
                        ...
                        Thread.Sleep(int.Parse(sec4.Text));
                    }
                    else if (cb_4.Text == "인")
                    {
                        index_fx(j);
                ...
                {                                       // asdf.runfx(1);  {cb_아몰랑}  public void asdf(속성 변수, 속성 변수) 해서 변수에 cb_1 , dan_1 이런식으로 넣어도 될듯
                    if (cb_5.Text.Equals("5"))
                    {
                        ...
                        Thread.Sleep(int.Parse(sec5.Text));
                    }
                    else if (cb_5.Text == "인")
                    {
                        index_fx(j);
                ...
                {                                       // asdf.runfx(1);  {cb_아몰랑}  public void asdf(속성 변수, 속성 변수) 해서 변수에 cb_1 , dan_1 이런식으로 넣어도 될듯
                    if (cb_6.Text.Equals("6"))
                    {
                        ...
                        Thread.Sleep(int.Parse(sec6.Text));
                    }
                    else if (cb_6.Text == "인")
                    {
                        index_fx(j);
                ...
                {                                       // asdf.runfx(1);  {cb_아몰랑}  public void asdf(속성 변수, 속성 변수) 해서 변수에 cb_1 , dan_1 이런식으로 넣어도 될듯
                    if (cb_7.Text.Equals("7"))
                    {
                        ...
                        Thread.Sleep(int.Parse(sec7.Text));
                    }
                    else if (cb_7.Text == "인")
                    {
                        index_fx(j);
                ...
                {                                       // asdf.runfx(1);  {cb_아몰랑}  public void asdf(속성 변수, 속성 변수) 해서 변수에 cb_1 , dan_1 이런식으로 넣어도 될듯
                    if (cb_8.Text.Equals("8"))
                    {
                        ...
                        Thread.Sleep(int.Parse(sec8.Text));
                    }
                    else if (cb_8.Text == "인")
                    {
                        index_fx(j);
